-- Create enum types for fitness goals and activity levels
...
CREATE TABLE public.workouts (
  ...
  workout_type TEXT DEFAULT 'other', -- cardio, strength, yoga, sports, other
  notes TEXT,
...
CREATE INDEX idx_meals_user_id_meal_time ON public.meals(user_id, meal_time);
CREATE INDEX idx_workouts_user_id_workout_date ON public.workouts(user_id, workout_date);
CREATE INDEX idx_weight_logs_user_id_log_date ON public.weight_logs(user_id, log_date);
CREATE INDEX idx_daily_summaries_user_id_date ON public.daily_summaries(user_id, summary_date);